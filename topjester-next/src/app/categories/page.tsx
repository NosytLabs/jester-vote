          ...
          {categories.map((cat) => {
            ...
            return (
              <Link key={cat.id} href={`/leaderboard?category=${cat.id}`}>
                <div className={`bg-gradient-to-br ${cat.gradient} border border-[#3f3f5f] rounded-xl p-6 hover:border-[#fbbf24]/50 cursor-pointer group h-full transition-[border-color,box-shadow] duration-200 ease-[var(--ease-out)]`}>
